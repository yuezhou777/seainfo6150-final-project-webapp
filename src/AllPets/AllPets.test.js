...
import AllPets from "./AllPets.jsx";
import { BrowserRouter } from 'react-router-dom';

describe('AllPets test', () => {

    it('render AllPets successfully ', () => {
        const posts = [
            {
                "id":"1",
                "title":"Mel",
        ...
        const {container} = render(<BrowserRouter><AllPets posts={posts} /></BrowserRouter>);
