...
import IndividualCategoryPage from "./IndividualCategoryPage.jsx";
import { BrowserRouter } from 'react-router-dom';

describe('IndividualCategoryPage test', () => {

    it('render IndividualCategoryPage successfully ', () => {
        ...
        const {container} = render(<BrowserRouter><IndividualCategoryPage category={category} posts={posts} /></BrowserRouter>);
